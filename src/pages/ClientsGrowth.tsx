...
const SUB_PRODUCT_COLORS: Record<SubProductKey, string> = {
  ...
  caasParceiros: 'hsl(165 75% 38%)',
  saasOxy: 'hsl(258 90% 66%)',
  saasOxyGenio: 'hsl(280 85% 60%)',
  saasSetup: 'hsl(290 80% 55%)',
  saasParceiros: 'hsl(300 75% 50%)',
  saasOxyGenioEsp: 'hsl(310 70% 55%)',
  educationDonoCFO: 'hsl(38 92% 50%)',
  educationEN: 'hsl(45 85% 48%)',
  educationFR: 'hsl(52 80% 45%)',
  educationFSP: 'hsl(58 75% 42%)',
  baas: 'hsl(340 82% 52%)',
  baasFranquia: 'hsl(350 78% 48%)',
  baasMasterFranquia: 'hsl(355 74% 44%)',
  taxAT: 'hsl(0 70% 50%)',
  taxGPT: 'hsl(15 75% 50%)',
  taxRCT: 'hsl(30 70% 50%)',
  taxRT: 'hsl(45 65% 50%)',
