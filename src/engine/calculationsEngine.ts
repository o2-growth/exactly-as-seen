  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { code: '5.06', label: 'Remuneração de Estagiários', annual: z, monthly: zMo() },
        { code: '5.12', label: 'Rescisões', annual: z, monthly: zMo() },
        ...
        { code: '5.13', label: 'Serviços de Terceiros', annual: z, monthly: zMo() },
        { code: '5.11', label: 'Produtos O2 - Endomarketing', annual: z, monthly: zMo() },
        { code: '5.14', label: 'Férias', annual: z, monthly: zMo() },
        { code: '5.15', label: '13º', annual: z, monthly: zMo() },
        { code: '5.16', label: 'Seguro de Vida', annual: z, monthly: zMo() },
      ],
    },
    {
